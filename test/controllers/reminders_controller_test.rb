...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { interval_seconds: @reminder.interval_seconds, message: @reminder.message, remind_at: @reminder.remind_at, type: @reminder.type } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { interval_seconds: @reminder.interval_seconds, message: @reminder.message, remind_at: @reminder.remind_at, type: @reminder.type } }
